...
<div id="container">
  <div id="hd">
    <div class="hd-wrap ue-clear text-info">
  ...
  <div id="bd">
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="konwledge">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="info-reg.html">知识列表</a></li>
              <li><a href="javascript:;" date-src="info-mgt.html">添加知识</a></li>
            </ul>
          </li>
          <li class="agency">
      ...
      <div class="content">
      	<!--
          	home.html路径：<?php echo u('home');?>   /index.php/Admin/Index/home
          -->
  ...
  <div id="ft" class="ue-clear">
    <div class="ft-left"> <span>中国铁动</span> <em>Office&nbsp;System</em> </div>
