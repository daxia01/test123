...
<div class="table-operate ue-clear">
	<a href="<?php echo u('Email/send');?>" class="add">添加</a>
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="status"><?php if($vo["isread"] == 0): ?><span style="color:red">未读</span><?php else: ?><span style="color:orange " >已读</span><?php endif; ?></td>
                <td class="operate">
                	<a href ='javascript:;' class="show" date="<?php echo ($vo["id"]); ?>" date-title="<?php echo ($vo["title"]); ?>" isread="<?php echo ($vo["isread"]); ?>">查看</a> 
                </td>
...
<script type="text/javascript">
	//layer.alert('hello word');die; 弹出hello word
