...
<div class="main">
	<p class="short-input ue-clear">
    	<label>标题：</label>
        <input name="title" type="text" value="<?php echo ($date["title"]); ?>" placeholder="标题..." />
    ...
    <p class="short-input ue-clear">
    	<label>作者：</label>
        <input name="author" type="text" value="<?php echo ($date["author"]); ?>" placeholder="作者..." />
    </p>
    <p class="short-input ue-clear">
    	<label>内容：<script id="editor" name="content" type="text/plain" style="width:800px;height:300px;"><?php echo (htmlspecialchars_decode($date["content"])); ?></script></label>
